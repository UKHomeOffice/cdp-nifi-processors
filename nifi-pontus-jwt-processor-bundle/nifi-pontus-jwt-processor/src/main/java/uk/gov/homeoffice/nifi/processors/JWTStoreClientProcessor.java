...
public class JWTStoreClientProcessor extends AbstractProcessor {
  ...
  public static final PropertyDescriptor JWT_ZK_PATH = new PropertyDescriptor.Builder()
    .name("JWT Zookeeper Path")
    .description("The path where the JWT will be added to Zookeeper. ")
    .defaultValue(JWT_ZK_PATH_DEFVAL)
    .required(true)
    .expressionLanguageSupported(false)
    .addValidator(StandardValidators.NON_BLANK_VALIDATOR)
    .build();

  public static final PropertyDescriptor JWT_ZK_HOST = new PropertyDescriptor.Builder()
    .name("JWT Zookeeper Connection")
    .description("The connection string (host:port<,host2:port>/<opt root>) to the Zookeeper cluster where the JWT will be added. ")
  ...
  public static final PropertyDescriptor JWT_JSON = new PropertyDescriptor.Builder()
    .name("JWT JSON String")
  ...
  public static final PropertyDescriptor JWT_USER_JSON = new PropertyDescriptor.Builder()
    .name("JWT USER JSON String")
    .description("The User with which to key the JWT")
    .defaultValue("${\"http.headers.Authorization\":jsonPath('$.preferred_username')}")
    .required(true)
    .expressionLanguageSupported(true)
    .addValidator(StandardValidators.ATTRIBUTE_EXPRESSION_LANGUAGE_VALIDATOR)
    .build();
