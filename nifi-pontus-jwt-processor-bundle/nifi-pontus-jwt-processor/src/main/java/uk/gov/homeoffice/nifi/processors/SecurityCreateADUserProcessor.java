 ...
 * @author Leo Martins
 */
@Tags({"pontus", "Active Directory", "AD", "Security"})
@CapabilityDescription("Creates an active directory user.")
public class SecurityCreateADUserProcessor extends AbstractProcessor {
  ...
  public static class NewUser {
    ...
    public NewUser(String domainName, String domainRoot, String domainURL, String adminNameDN, String adminPasswd, String userName, String password, String userGroup) throws NamingException {
...
//    .build();
  ...
  public static final PropertyDescriptor DOMAIN_NAME = new PropertyDescriptor.Builder()
    ...
    .description("The AD domain name where the user will be created. ")
    .defaultValue("TEST2.LOCAL")
    .required(true)
    .expressionLanguageSupported(false)
    .addValidator(adCredentialsValidator)
    .build();


  public static final PropertyDescriptor DOMAIN_ROOT = new PropertyDescriptor.Builder()
    .name("Active Directory Domain Root")
    .description("The AD domain root where the user will be created. ")
    .defaultValue("CN=Users,DC=test2,DC=local")
    .required(true)
    .expressionLanguageSupported(false)
    .addValidator(adCredentialsValidator)
    .build();
  ...
  public static final PropertyDescriptor DOMAIN_URL = new PropertyDescriptor.Builder()
    .name("Active Directory Domain URL")
    .description("The AD domain URL where the user will be created. ")
    .defaultValue("ldaps://test2-ad.test2.local:636")
    .required(true)
    .expressionLanguageSupported(false)
    .addValidator(adCredentialsValidator)
    .build();
  ...
  public static final PropertyDescriptor ADMIN_NAME = new PropertyDescriptor.Builder()
    ...
    .defaultValue("CN=leo.martins,CN=Users,DC=test2,DC=local")
    .required(true)
    .expressionLanguageSupported(false)
    .addValidator(adCredentialsValidator)
    .build();
  ...
  public static final PropertyDescriptor USER_NAME = new PropertyDescriptor.Builder()
    .name("New User Name")
    .description("The new User name to be added to AD.")
  ...
  public static final PropertyDescriptor USER_PASSWD = new PropertyDescriptor.Builder()
    .name("New User Password")
    .description("The new User's password to be added to AD.")
    .defaultValue("testuser1£££££6666777erKK")
    .required(true)
    .expressionLanguageSupported(true)
    .addValidator(StandardValidators.ATTRIBUTE_EXPRESSION_LANGUAGE_VALIDATOR)
    .build();
  public static final PropertyDescriptor USER_GROUP = new PropertyDescriptor.Builder()
    .name("New User Group")
    .description("The new User's AD group.")
    .defaultValue("CN=Administrators,CN=Builtin,DC=test2,DC=local")
    .required(true)
    .expressionLanguageSupported(true)
    .addValidator(StandardValidators.ATTRIBUTE_EXPRESSION_LANGUAGE_VALIDATOR)
    .build();
...
//
  ...
  public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
    ...
    try {
      NewUser user = new NewUser(domainName, domainRoot, domainURL, adminNameDN, adminPasswd, userName, userPassd, userGroup);
      user.addUser();
