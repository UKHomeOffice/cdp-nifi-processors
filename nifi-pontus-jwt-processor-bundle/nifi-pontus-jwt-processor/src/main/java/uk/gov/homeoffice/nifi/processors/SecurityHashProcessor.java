 ...
 * @author Leo Martins
 */
@Tags({"pontus", "Hash", "Security"})
@CapabilityDescription("Creates a hash from a string using a secret key.")
public class SecurityHashProcessor extends AbstractProcessor {
...
//    .build();
  ...
  public static final PropertyDescriptor HASH_KEY_ALGO = new PropertyDescriptor.Builder()
    .name("Hash Key Algo")
    ...
    .expressionLanguageSupported(false)
    .addValidator(keySignValidator)
    .allowableValues("HmacSHA1", "HmacSHA256", "HmacSHA384", "HmacSHA512")
    .build();
  ...
  public static final PropertyDescriptor HASH_ENCRYPTED_STRING_ATTRIBUTE_NAME = new PropertyDescriptor.Builder()
    ...
    .defaultValue("hashed_string_output")
    .required(true)
    .expressionLanguageSupported(false)
  ...
  public static final PropertyDescriptor HASH_RAW_STRING = new PropertyDescriptor.Builder()
    .name("Input Raw String pre-hash")
