...
//  public static final JsonProvider JSON_PROVIDER = STRICT_PROVIDER_CONFIGURATION.jsonProvider();
  ...
  public static String replaceTokensEscapeSingleQuotes(Map<String, String> nameValuePairs, String templateStr, int maxReplacements, String escapeChar) {
...
//                    .append(nameValuePairs.get(lastName)).append(">; trying simple replace.").toString());
  ...
  public static String replaceTokens(Map<String, JsonPath> nameValuePairs, JsonNode jsonNode, String templateStr, int maxReplacements) {
    if (nameValuePairs == null || templateStr == null) {
      return null;
    }
...
//                    .append(nameValuePairs.get(lastName)).append(">; trying simple replace.").toString());
  ...
  public static String replaceAddOne(String defaultVal) {
    ...
    try {
      ...
      if (!lastMatch.isEmpty()) {
        ...
        strBuilder.replace(retVal.lastIndexOf(lastMatch), retVal.lastIndexOf(lastMatch) + lastMatch.length(),
          tempRetVal);
  ...
  public static String convertCPUListToHex(final String csvCPUList, final int numHexBytes, final int leadingZeros, final int sizeOfLong) {
